...
namespace Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260807011048_AddUserDataTablePreferences")]
    partial class AddUserDataTablePreferences
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Models.ApplicationAccess", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("ApplicationId", "UserId", "RoleId")
                        .IsUnique();

                    b.ToTable("ApplicationAccesses");
                });
            ...
            modelBuilder.Entity("Domain.Models.IntegrationInboxMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Domain.Models.IntegrationOutboxMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("PublishedAtUtc", "DeadLetteredAtUtc", "AvailableAtUtc");
            ...
            modelBuilder.Entity("Domain.Models.Notification", b =>
                {
                    ...
                    b.HasIndex("RecipientUserId", "CreatedOn");

                    b.ToTable("Notifications");
                });

            modelBuilder.Entity("Domain.Models.NotificationDelivery", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("NotificationOutboxId", "RecipientUserId", "Channel")
                        .IsUnique();

                    b.ToTable("NotificationDeliveries");
                });

            modelBuilder.Entity("Domain.Models.NotificationOutbox", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Domain.Models.NotificationPolicy", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Domain.Models.NotificationTemplate", b =>
                {
                    ...
                    b.HasIndex("EventKey", "Channel", "IsPublished");

                    b.HasIndex("EventKey", "Channel", "Version")
                        .IsUnique();
            ...
            modelBuilder.Entity("Domain.Models.UserContactProfile", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("UserContactProfiles");
                });

            modelBuilder.Entity("Domain.Models.UserDataTablePreference", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("ApplicationId", "UserId", "TableKey")
                        .IsUnique();

                    b.ToTable("UserDataTablePreferences");
                });

            modelBuilder.Entity("Domain.Models.UserNotificationPreference", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<bool>("ApprovalDecisionsPush")
                        .HasColumnType("boolean");

                    b.Property<bool>("ApprovalTasksPush")
                        .HasColumnType("boolean");
                    ...
                    b.Property<bool>("OrderUpdatesPush")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("Domain.Models.Vendor", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("SourceChangedAtUtc")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("Domain.Models.NotificationDelivery", b =>
                {
                    b.HasOne("Domain.Models.NotificationOutbox", "NotificationOutbox")
                        .WithMany("Deliveries")
