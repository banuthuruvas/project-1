...
public class AuditLogger : IAuditLogger
{
    ...
    public async Task LogSessionExpiredAsync(string userId, string sessionId)
    {
        var entry = CreateBaseEntry(
            EAuditAction.SessionExpired,
            EAuditCategory.Authentication,
            EAuditSeverity.Info,
            "Session",
            AuditValueSanitizer.FingerprintSessionId(sessionId));
        entry.UserId = userId;
    ...
    public async Task LogJobExecutedAsync(string jobName, long durationMs, string outcome = "Success", string? details = null)
    {
        var severity = outcome == "Success" ? EAuditSeverity.Info : EAuditSeverity.Error;
    ...
    public async Task LogEmailSentAsync(string recipient, string subject, string outcome = "Success")
    {
